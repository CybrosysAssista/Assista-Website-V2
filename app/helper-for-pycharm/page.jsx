...
function Page() {
  ...
  return (
    <div>
      <Header />
      <div className="">
        <div className="cmpad pt-40 slider inslider pycharmslilder lg:h-screen">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-10 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <Image src="/img/pycharm.svg" alt="" width={50} height={50} />
              ...
              <h1 className="text-[35px] sm:text-[45px] font-medium mb-3 leading-12 md:leading-15">
                ...
                Workflow with
                <span className="brush brushpycharm">Odoo Helper.</span>
              </h1>
              <p className="max-w-[600px] leading-7 text-[#7e7e7e]">
                Enhance Odoo development in PyCharm with intelligent code
                assistance, quick navigation, and built in insights for a
        ...
        <div className="cmpad pt-10 pb-10 md:pt-0 md:pb-10">
          <section id="ide-docs" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Grow business with{" "}
              <span className="underlineimg underlinepycharm">
                automation tools
              </span>
            </h2>
          ...
          <section id="customers" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              ...
              <span className="underlineimg underlinepycharm"> developers</span>
            </h2>
          ...
          <section id="faq" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Frequently Asked{" "}
              <span className="underlineimg underlinepycharm">Questions</span>
            </h2>
