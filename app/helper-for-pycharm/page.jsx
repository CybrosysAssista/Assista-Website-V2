...
function Page() {
  ...
  return (
    <div>
      <Header />
      <div className="cmpad pt-30 slider inslider pycharmslider">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-5xl font-medium mb-3 leading-15">
              Supercharge your <br /> Workflow with
            ...
            <p className="max-w-[600px] leading-7 text-[#7e7e7e]">
              ...
              assistance, quick navigation, and built in insights for a smoother
              coding experience.
            </p>
