...
function Page() {
  ...
  return (
    <div>
      <Header />
      <div className="">
        <div className="cmpad pt-40 slider inslider pslider lg:h-screen">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-10 items-center">
            <div>
              ...
              <h1 className="text-[35px] sm:text-[45px] font-medium mb-3 leading-12 md:leading-15">
                Your assistant to
                <br className="hidden lg:block" /> Optimize more
        ...
        <div className="cmpad pt-10 pb-10 md:pt-0 md:pb-10">
          ...
          <section id="collaborate" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Work together with{" "}
              <span className="underlineimg underlinep">
          ...
          <section id="security" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Enterprise grade{" "}
              <span className="underlineimg underlinep">security features</span>
            </h2>
          ...
          <section id="customers" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              ...
              <span className="underlineimg underlinep"> developers</span>
            </h2>
          ...
          <section id="faq" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Frequently Asked{" "}
              <span className="underlineimg underlinep">Questions</span>
            </h2>
