        ...
        <div className="cmpad pt-10 pb-10 md:pt-0 md:pb-10">
          <section id="ide-docs" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Grow business with{" "}
              <span className="underlineimg underlinevscode">
                automation tools
              </span>
            </h2>
          ...
          <section id="customers" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              ...
              <span className="underlineimg underlinevscode"> developers</span>
            </h2>
          ...
          <section id="faq" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Frequently Asked{" "}
              <span className="underlineimg underlinevscode">Questions</span>
            </h2>
