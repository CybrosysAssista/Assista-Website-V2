...
function Page() {
  ...
  return (
    <div>
      <Header />
      <div className="">
        <div className="cmpad pt-40 slider inslider xslider lg:h-screen">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-10 items-center">
            <div>
              ...
              <h1 className="text-[35px] sm:text-[45px] font-medium mb-3 leading-12 md:leading-15">
                Your assistant to
                <br className="hidden lg:block" /> Automate
                <span className="brush brushx">everything.</span>
              </h1>
              <p className="max-w-[600px] leading-7 text-[#7e7e7e]">
                Assista X brings AI-powered automation to your workflow from
                handling repetitive tasks to providing insights so you can focus
                on matters.
              </p>
        ...
        <div className="cmpad pt-10 pb-10 md:pt-0 md:pb-10">
          <section id="ide-docs" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Grow business with{" "}
              <span className="underlineimg underlinex">automation tools</span>
            </h2>
          ...
          <section id="collaborate" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Work together with{" "}
              <span className="underlineimg underlinex">
          ...
          <section id="security" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Enterprise grade{" "}
              <span className="underlineimg underlinex">security features</span>
            </h2>
          ...
          <section id="customers" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              ...
              <span className="underlineimg underlinex"> developers</span>
            </h2>
          ...
          <section id="faq" className="mb-16">
            ...
            <h2 className="mainhead relative w-max m-auto">
              Frequently Asked{" "}
              <span className="underlineimg underlinex">Questions</span>
            </h2>
