...
function Hero() {
  return (
    <div className="cmpad h-screen pt-10 slider">
      <Image
        src="/img/globe.svg"
        alt="Globe"
        width={300}
          ...
          <div>
            <h1 className="text-5xl font-medium mb-3 leading-15">
              ...
              <span className="bg-gradient-to-r from-[#e97d83] to-[#e19bff] bg-clip-text text-transparent relative">
                <Image src="/img/arrow.svg" alt="" width={100} height={100} className="absolute -right-25 -top-6"/>
                build faster.
              </span>
            </h1>
            <p className="max-w-[600px] leading-7 text-[#7e7e7e]">
              A platform that offers a range of utilities including development
              plugins a learning hub ready to use installation scripts cheat
              sheets and more.
            </p>
