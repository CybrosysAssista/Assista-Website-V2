...
function Header() {
  ...
  return (
    <header className="fixed bg-white border-b border-[#e97d8326] top-0 left-0 w-full z-50 transition-all [box-shadow:0px_5px_20px_rgb(0_0_0_/_3%)]">
      <div className="container-fluid cmpad">
        ...
        >
          ...
          <nav className="hidden lg:flex flex-1 items-center justify-end gap-15">
            ...
            <a
              href="/login"
              className="px-6 py-3 bg-[var(--primary-color)] text-white rounded-md flex gap-2 items-center hover:bg-[#aa6e71] transition duration-300"
            >
              <svg
