...
const NewsDetail = () => {
  // 📰 Article Data (you can add more objects later)
  const articles = [
    {
      id: 1,
      category: "Technology",
      ...
      subtitle:
        "Discover the cutting edge technologies and methodologies that will define web development in the coming year.",
      author: "Jane Doe",
      date: "December 15, 2024",
      readTime: "8 min read",
      views: "1,234 views",
      image:
        "https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800", // ✅ make sure this image exists in your /public/img folder
      content: `
        <p>
          The web development landscape is constantly evolving, and 2025 promises
          to bring exciting new trends that will reshape how we build and interact
          with web applications. From artificial intelligence integration to
          advanced performance optimization techniques, developers need to stay
        ...
        <p>
          ...
          Tools like <strong>GitHub Copilot</strong> and <strong>ChatGPT</strong> are becoming essential parts
          of the development workflow, helping developers write better code faster
          and catch potential issues before they become problems.
        </p>

        <blockquote>
          "AI won't replace developers, but developers who use AI will replace
          those who don't." – Industry Expert
        </blockquote>

        <h2>2. Progressive Web Apps (PWAs) Evolution</h2>
        <p>
          Progressive Web Apps continue to blur the line between web and native
          applications. With improved capabilities and better browser support, PWAs
          are becoming the go-to solution for businesses wanting to provide
          app-like experiences without the complexity of native development.
        </p>
        ...
        <p>
          WebAssembly is finally reaching mainstream adoption, enabling developers
          to run high-performance applications in the browser. Languages like
          <code>Rust</code>, <code>C++</code>, and <code>Go</code> can now be compiled to run in web
          browsers with near-native performance.
        </p>

        <p>
          This opens up possibilities for complex applications like
          <code>video editing software</code>, <code>3D modeling tools</code>, and
          <code>scientific simulations</code> to run directly in the browser without
          plugins.
        </p>
        ...
        <p>
          ...
          micro-frontend architecture is gaining traction. This approach allows
          different teams to work on different parts of a web application
          independently, improving development velocity and maintainability.
        </p>

        <h2>5. Advanced CSS Features</h2>
        <p>
          CSS continues to evolve with new features that reduce the need for
          JavaScript. Container queries, CSS Grid subgrid, and advanced selectors
          are making layouts more flexible and maintainable than ever before.
        </p>

        <h2>Conclusion</h2>
        <p>
          The future of web development is bright and full of opportunities. By
          staying informed about these trends and experimenting with new
          technologies, developers can build better, faster, and more engaging web
          experiences. The key is to balance innovation with practical
          implementation, ensuring that new technologies truly benefit both
  ...
  // 👉 select first article for display
  const article = articles[0];

  return (
    <>
      <Header />
      <main className="mx-auto px-4 py-10 max-w-4xl pt-30">
        <div className="article-container">
          ...
          {/* Featured Image */}
          <div className="featured-image mb-10 rounded-lg overflow-hidden">
            <img
              src={article.image}
              alt={article.title}
          ...
          {/* Article Content */}
          <article
            className="article-content prose max-w-none text-gray-700 leading-relaxed"
